...
<body bgcolor="white"><p>
	...
	<tr><td colspan="3">
	 ...
	 <tr> 
	 <td colspan="1" align="left" valign="top"> <object type="text/plain"  data="checkid.do?action=displayfile&amp;subid=<%= listSubmitID %>&amp;ctype=txt&amp;file=out.txt" width="850" height="900"></object> </td> 
