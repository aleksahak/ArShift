...
# Example Runs
# DATA<-RingNormExp(c(0.7,0.5, -3),c(1,1,0),c(1.5,0.5,0),c(1,0,0),c(0.5,0,0),c(0,0.5,0),c(0.5,1,0))
# DATA<-RingNormExp(c(0.7,0.5, -3),c(0.5,1,0),c(0,0.5,0),c(0.5,0,0),c(1,0,0),c(1.5,0.5,0),c(1,1,0))
