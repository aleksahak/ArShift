...
FUN <- function(Seq.line) {
  ...
  resName <- unique(parsed.pdb$resName[ind])[1]            ########## NEEDED FOR RARE SITUATIONS: ALTERED [1] to assure that only one is taken, in case there are multiple residue types at the same Seq and Chain Positions............
